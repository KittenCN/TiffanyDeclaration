...
namespace BHair.Business
{
    public class PrintExcel
    {
        ...
        public DataTable ExcelToDataTable_HS(string filePath, string strOrderNO)
        {
            ...
            try
            {
                ...
                for (int iRow = 2; iRow <= iRowCount + 1; iRow++)
                {
                    ...
                    dr["Shop_Receiver"] = ((Excel.Range)worksheet.Cells[iRow, 7]).Text;
        ...
        public DataTable ExcelToDataTable_INV(string filePath, string strOrderNO)
        {
            DataTable Result = new DataTable();
            Result.Columns.Add(new DataColumn("OrderNO", typeof(string)));
            Result.Columns.Add(new DataColumn("Status", typeof(int)));
        ...
        public DataTable ExcelToDataTable_WMSinDetail(string filePath, string strOrderNO)
        {
            ...
            try
            {
                ...
                for (int iRow = 2; iRow <= iRowCount + 1; iRow++)
                {
                    ...
                    dr["OrderNO"] = "";
                    dr["Status"] = 0;
                    dr["InboundNO"] = strOrderNO;
                    dr["SKU"] = ((Excel.Range)worksheet.Cells[iRow, 4]).Text.ToString();
                    dr["DESCRIPTION"] = ((Excel.Range)worksheet.Cells[iRow, 2]).Text.ToString();
                    dr["OutsiteSize"] = 0;
                    dr["Specification"] = "";
                    dr["CARTON"] = 1;
                    dr["PCs"] = int.Parse(((Excel.Range)worksheet.Cells[iRow, 5]).Text.ToString());
                    dr["Remarks"] = "";
                    dr["WMSNO"] = ((Excel.Range)worksheet.Cells[iRow, 1]).Text.ToString();
                    dr["ItemNO"] = ((Excel.Range)worksheet.Cells[iRow, 3]).Text.ToString();
                    if (validate == 0) Result.Rows.Add(dr);
                }
                return Result;
            }
        ...
        public bool ExtoEXCELfromInD(DataTable AppDT, DataTable DetailDT, string SaveAdd)
        {
            ...
            {
                intDTRows = 0;
                for(int x = 22; x < 22 + DetailDT.Rows.Count + 3; x++)
                {
                    if (x == 22)
                    {
                        switch (y)
                    ...
                    else if (x == 22 + DetailDT.Rows.Count + 2)
                    {
                        switch (y)
                        {
                            case 6:
        ...
        public DataTable ExcelToDataTable_WMSReceiptInfo(string filePath, string strOrderNO)
        {
            DataTable Result = new DataTable();
            Result.Columns.Add(new DataColumn("Shop", typeof(string)));
            Result.Columns.Add(new DataColumn("Clerk", typeof(string)));
            Result.Columns.Add(new DataColumn("Contact", typeof(string)));
            Result.Columns.Add(new DataColumn("Level", typeof(string)));
            ...
            try
            {
                ...
                for (int iRow = 2; iRow <= iRowCount + 1; iRow++)
                {
                    int validate = 0;
                    DataRow dr = Result.NewRow();
                    dr["Shop"] = ((Excel.Range)worksheet.Cells[iRow, 1]).Text.ToString();
                    dr["Clerk"] = ((Excel.Range)worksheet.Cells[iRow, 2]).Text.ToString();
                    dr["Contact"] = ((Excel.Range)worksheet.Cells[iRow, 3]).Text.ToString();
                    dr["Level"] = ((Excel.Range)worksheet.Cells[iRow, 4]).Text.ToString();
                    dr["Address"] = ((Excel.Range)worksheet.Cells[iRow, 5]).Text.ToString();
                    if (validate == 0) Result.Rows.Add(dr);
                }
                return Result;
            }
